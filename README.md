...
本项目采用完全定制的 **《伪娘许可证》The Femboy License v2.0**,全文见 [LICENSE](LICENSE)。要点:

- **对一切「非适用对象」使用者**(包括所有女性、未成年人与法人):**无条件授权**,宽松程度不低于 MIT-0——无署名义务、无任何约束。
- **对成年男性使用者**:同等权限,但许可要约仅向持有「立志成为合格的伪娘」之志向者发出;志向纯属内心状态,以使用行为自证即视为满足,任何人无权盘问或举证推翻(许可证 § 3.2)。
- 安全与合法性边界、商标保留、免责声明见许可证第四、五条。
